<?php
    require ('require/header2.php');
?>
<br><br><br>

<title>Uniendo Puntos</title>

   <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="../index.html">Inicio</a></li>
        <li class="breadcrumb-item"><a href="../index.html">Didacticas Primaria</a></li>
        <li  class="breadcrumb-item active">Uniendo los puntos</li>
    </ul>

    <h1 class="title_contenido">Uniendo los puntos</h1>
