        ...
        <div class="menu" id="show-menu">
            ...
            <nav>
                <ul>
                    ...
                    <li class="menu-selected"><a href="../index.php #preescolar" class="text-menu-selected"> 
                        <i class="fas fa-file-alt"></i>Dinamicas Preescolar</a></li>
                    <li><a href="../index.php #primaria"> <i class="fas fa-home"></i> Dinamicas Primaria</a></li>
